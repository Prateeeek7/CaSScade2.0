      ...
      <div className="relative z-10">
        ...
        <section className="min-h-screen flex flex-col justify-center items-center px-4 py-20">
          ...
          >
            ...
            >
              <span className="inline-block transform -skew-x-12 font-extrabold">C</span>
              <span className="inline-block transform skew-x-12 font-extrabold">a</span>
              <span className="inline-block transform -skew-x-6 font-extrabold">S</span>
              <span className="inline-block transform skew-x-6 font-extrabold">S</span>
              <span className="inline-block transform -skew-x-12 font-extrabold">c</span>
              <span className="inline-block transform skew-x-12 font-extrabold">a</span>
              <span className="inline-block transform -skew-x-6 font-extrabold">d</span>
              <span className="inline-block transform skew-x-6 font-extrabold">e</span>
              <span className="inline-block transform -skew-x-12 font-extrabold">'</span>
              <span className="inline-block transform skew-x-12 font-extrabold">2</span>
              <span className="inline-block transform -skew-x-6 font-extrabold">5</span>
            </motion.h1>
          ...
          >
            ...
            >
              ...
              <motion.div
                ...
                style={{
                  background: 'linear-gradient(45deg, #0076C0, #0056A0, #0076C0)',
        ...
        >
          <div className="max-w-4xl mx-auto text-center">
            <motion.div
              className="border border-orange-500 p-4 sm:p-6 md:p-8 rounded-lg bg-black/50 backdrop-blur-sm mb-8 sm:mb-12"
              style={{
          ...
          <div className="max-w-6xl mx-auto">
            ...
            >
              <div>
                ...
                >
                  <p>
                    CSI VIT is a vibrant community of 
                    <motion.span 
                      ...
                      transition={{ duration: 2, repeat: Infinity }}
                    >
                      {" makers, breakers and innovators "}
                    </motion.span>
                    .
                  </p>
                  <p>
                    We bring together developers, designers and problem solvers to explore cutting edge technology through hackathons, workshops and real world projects.
                  </p>
                  <p>
                    Backed by India's largest network of computer professionals, CSI VIT gives you the 
                    <motion.span 
                      className="text-orange-400 font-bold"
                      animate={{ 
                        textShadow: [
                      ...
                      transition={{ duration: 2, repeat: Infinity, delay: 1 }}
                    >
                      {" skills, exposure and platform "}
                    </motion.span>
                    to grow.
                  </p>
                  <p className="text-cyan-400">
                    Whether you want to code, design or disrupt, there is always a place for you here.
                  </p>
                </motion.div>
                ...
                <motion.div className="mt-8">
                  <motion.a
                    ...
                    whileTap={{ scale: 0.95 }}
                    style={{
                      boxShadow: '0 0 20px rgba(0, 118, 192, 0.4), 0 0 40px rgba(234, 75, 33, 0.4)'
                    }}
                  >
                    <span className="relative z-10">Visit CSI-Computer Society of India</span>
                    <motion.div
                      className="absolute inset-0 bg-gradient-to-r from-blue-600 to-orange-600 opacity-0 group-hover:opacity-100 transition-opacity duration-300"
                      style={{
                        background: 'linear-gradient(45deg, #0076C0, #EA4B21, #0076C0)',
                        backgroundSize: '200% 200%'
                      }}
                      animate={{
              ...
              <div className="relative">
                <motion.div
                  className="w-full h-80 border border-purple-500 rounded-lg bg-black/30 backdrop-blur-sm p-6"
                  style={{
                    boxShadow: '0 0 30px rgba(139, 92, 246, 0.3)'
                  }}
                  animate={{
